...
io.write(string.format("At temperature T=%2.3f Kelvin, the magnetic moment is:\n", T/EnergyUnits.Kelvin.value))
...
--L2,3 x-ray absorption spectra and  magnetic circular dichroism
Spectra_ave  = (Spectra_z + Spectra_l + Spectra_r)/3
Spectra_XMCD = (Spectra_r - Spectra_l)

--Calculating  the components of the conductivity tensor (sigma[i,j])
Sigma_11 = Sigma_X
Sigma_22 = Sigma_Y
Sigma_33 = Sigma_Z
